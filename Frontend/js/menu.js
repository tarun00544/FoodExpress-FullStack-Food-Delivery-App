...
const CATEGORY_ICONS = {
    ...
    "Pizza":"image/pizza.jpeg",
    "Burger":"image/burgerPOSTER.jpeg",
    "Sandwich":"image/sandwich.jpeg",
    "Pasta":"image/pasta.jpeg",
    "Chinese":"image/chinese.jpeg",
    "Noodles":"image/noodles.jpeg",
    "Momos":"image/momos.jpeg",
    "Rolls & Wraps":"image/roll.jpeg",
    "Biryani":"image/biryani.jpeg",
    "North Indian":"image/north-indian.jpeg",
    "South Indian":"image/dosa.jpeg",
    "Street Food":"image/street-food.jpeg",
    "Fast Food":"image/fast-food.jpeg",
    "Snacks":"image/snacks.jpeg",
    "Desserts":"image/dessert.jpeg",
    "Ice Cream":"image/icecream.jpeg",
    "Bakery":"image/bakery.jpeg",
    "Beverages":"image/drinks.jpeg",
    "Healthy Food":"image/healthy.jpeg",
    "Salads":"image/salad.jpeg"
...
`;
    ...
    const categoryFood = foods.find(food => food.category === category);

    const image = categoryFood
        ? categoryFood.image
...
MENU_STATE.category=item.dataset.category;
  ...
  <div class="col-sm-6 col-lg-4 fe-food-col" data-id="${id}">
    <div class="fe-card h-100 d-flex flex-column">
      ...
      <div class="p-3 d-flex flex-column flex-grow-1">
        ...
        <button
class="btn btn-warning w-100 mt-2 order-now-btn"
data-id="${food._id}">
...
function attachCardEvents(container) {
  container.querySelectorAll(".fe-add-to-cart-btn").forEach((btn) => {
    ...
    container.querySelectorAll(".order-now-btn")
.forEach(btn=>{
...
async function loadCategoryOptions() {
  ...
  if (!select) return;
  try {
    const res = await fetchFoods({ limit: 1000 });
    const foods = extractList(res);
  ...
  if (window.categoryChoices) {
    window.categoryChoices.destroy();
}

window.categoryChoices = new Choices("#filter-category", {
    searchEnabled: true,
    itemSelectText: "",
    shouldSort: false,
    placeholder: true,
...
MENU_STATE.category=chip.dataset.category;
