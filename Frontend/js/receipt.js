...
function renderReceipt(order){
    ...
    document.getElementById("customerFullName").innerText =
        order.address.fullName || "-";

    document.getElementById("customerAddress").innerText =
        order.address.address || "-";

    document.getElementById("customerCity").innerText =
        order.address.city || "-";

    document.getElementById("customerState").innerText =
        order.address.state || "-";

    document.getElementById("customerPincode").innerText =
